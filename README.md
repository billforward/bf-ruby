...
As of [version 2.2016.209](https://rubygems.org/gems/bill_forward/versions/2.2016.209): the SDK targets Ruby 2.3.1. There is a possibility that it is compatible with Rubies as old as 1.9.3.
